...
const NewsLater = () => {
  return (
    <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
        ...
        <Title title='Unlock Exclusive Benefits' subtitle='Subscribe to receive premium offers and curated experiences tailored just for you.'/>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
                ...
                <FaArrowRight className='invert group-hover:translate-x-1 transition-all'/>
                </button>
            </div>
